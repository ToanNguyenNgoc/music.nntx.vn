...
export const ProfileView = () => {
  ...
  if (error || !profile) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center gap-4 spotify-gradient">
  ...
  return (
    <div className="flex-1 min-h-0 overflow-y-auto p-4 md:p-8 spotify-gradient">
      <div className="max-w-4xl mx-auto">
        <button 
          onClick={() => setCurrentView('home')}
          className="flex items-center gap-2 text-spotify-gray hover:text-white transition-colors mb-6 md:mb-8 group text-sm"
        >
        ...
        <motion.div 
          ...
          className="bg-spotify-dark rounded-2xl overflow-hidden shadow-2xl border border-white/5"
        >
          {/* Cover Header */}
          <div className="h-32 md:h-48 bg-gradient-to-r from-spotify-green/20 to-spotify-green/5 relative">
            <div className="absolute -bottom-12 md:-bottom-16 left-1/2 -translate-x-1/2 md:left-8 md:translate-x-0">
              <div className="w-24 h-24 md:w-32 md:h-32 rounded-full bg-spotify-light border-4 border-spotify-dark flex items-center justify-center shadow-2xl">
          ...
          <div className="pt-16 md:pt-20 pb-8 md:pb-10 px-6 md:px-8">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 text-center md:text-left">
              <div>
                <h1 className="text-2xl md:text-4xl font-black tracking-tight mb-2">{profile.fullname}</h1>
              ...
              <button 
                ...
                className="flex items-center justify-center gap-2 bg-white/10 hover:bg-red-500/20 hover:text-red-500 text-white font-bold py-2.5 md:py-3 px-8 rounded-full transition-all border border-white/10 text-sm md:text-base"
              >
                <LogOut size={20} />
                Logout
              </button>
              ...
              <div className="bg-white/5 p-6 rounded-xl border border-white/5 space-y-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{profile.status ? 'Active' : 'Inactive'}</p>
                  </div>
                </div>
