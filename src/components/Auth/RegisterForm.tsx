    ...
    <div className="min-h-screen flex items-center justify-center bg-black p-4">
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-3xl font-bold tracking-tight">Sign up for Spotify</h1>
        </div>
        ...
        <div className="mt-8 pt-8 border-t border-white/10 text-center">
          <p className="text-spotify-gray text-sm">
            Already have an account? <span onClick={onSwitchToLogin} className="text-white hover:text-spotify-green cursor-pointer underline font-bold">Log in</span>
          </p>
        </div>
      </motion.div>
    </div>
