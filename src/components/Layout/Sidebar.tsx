...
const SidebarItem = ({ icon: Icon, label, active, onClick }: SidebarItemProps) => (
  <button
    onClick={onClick}
    className={cn(
      "flex items-center gap-4 px-4 py-2 w-full text-spotify-gray hover:text-white transition-colors duration-200 font-medium text-left",
      active && "text-white"
    )}
  >
    <Icon size={24} />
...
export const Sidebar = () => {
  ...
  return (
    <aside className="w-20 lg:w-64 bg-black flex flex-col h-full py-6">
      <div className="px-6 mb-8">
        <div className="flex items-center gap-2 text-white cursor-pointer" onClick={() => setCurrentView('home')}>
